...
- クリア条件(いずれか)
  1. 「無言の帰還」と「鉄塊狩り」を成功し、インターコムに(そろそろ……)を選ぶ
  2. 「輝かしい捜索任務」をクリアし、インターコムに(そろそろ……)を選ぶ
...
### ミッション4「アリーヤ博士の行方を追う」
- 開始条件
  - 下記のいずれかの会話を聞いたあと、後輩と会話して「\[ミッション\](アリーヤ博士の行方について)」を選ぶ
...
- ウォークスルー(ヒント)<br/>
1. マップに表示された場所へ行き、現地で後輩と会話するだけです<br/>
※ 依頼主は「何か見つけたら～」と言いますが、何もありません。特に危険はないはずです
