...
- 会話より(気分転換に雑談に誘う)⇒(雑談を楽しむ)を選ぶと「後輩と楽しく会話した」効果により少しの間意欲が+15されます(上限:+30)。
   ...
   - 会話による意欲の変化は1時間継続し、その後1時間かけて0に戻ります。元に戻るとまた会話ができるようになります。
...
## ミッション攻略
### ミッション1 「科学研究所を目指そう」
1. 大変動から6日目以降※に後輩と会話すると(\[ミッション\]相談を聞く)が選択肢に現れるので選んでミッションを開始する<br/>
※ゲーム開始翌日を想定しています(「避難者」シナリオは大変動から5日目開始)<br/>
　この選択肢で\[ミッションを無効にする\]を選ぶと以降二度とミッションを提示しなくなります。

1. 目的地の科学研究所で両方が内側に居る状態で会話し、(\[ミッション\](研究所に着いたが……)」を選ぶとクリア<br/>
目的地でない科学研究所でもクリア条件を満たします。<br/>
ミッションのためなら地下に入る必要はありません。<br/>
...
### ミッション2「HUB01を目指そう」
#### ミッション1クリア時点でHUB01のインターコムに話しかけていない場合
1. 後輩との会話に(\[ミッション\]相談を聞く)が現れるので選んでミッションを開始する<br/>
※ハブ01は無限のマップにひとつしか存在できないので、探索に数十秒～かかる場合があります。気長に待ってください。
1. マップに表示されたハブ01にたどり着き、インターコムに話しかけて追加選択肢(親族に会いに来た)を選ぶ
1. 後輩と会話して追加選択肢(\[ミッション\]HUB01について)を選ぶ
1. インターコムに話しかけ追加選択肢(後輩のママについて尋ねる)を選ぶ
1. 後輩と会話するとクリア

#### ミッション1クリア前にHUB01のインターコムに話しかけた場合
1. インターコムに話しかける
1. 後輩との会話に(\[ミッション\]相談を聞く)が現れるので選ぶ
1. 一度インターコムに話しかけ、追加選択肢(後輩のママについて尋ねる)を選ぶ
1. 後輩と会話するとクリア

#### **【注意】**: ミッション1開始前にHUB01のインターコムに話しかけた場合<br/>
※ミッション1の開始条件が失われ、ミッション1が開始できなくなります<br/>
　結果としてミッション1の報酬である科学研究所が発見できなくなります。<br/>
　進行は上記「ミッション1クリア前にHUB01のインターコムに話しかけた場合」と同じです<br/>
...
1. HUB01のミッション「実地データを回収する」をクリアする<br/>
   ...
   - 説明にあったEMP手榴弾は博士がふたつ持っていますが、準備なく徒歩で近づいたりしたら手に入れる前にロボットに殺されるでしょう
...
1. 「鉄塊狩り」をクリアする(「無言の帰還」と順不同)
    ...
    - ミッションの説明と開始時にもらったアイテムをしっかり確認しましょう
      ...
      - UPSの電源は入れましょう(使用【a】)
      - 試作ライフルの弾は電力ですがマガジンは電源が入っており充電のあるUPSです。UPSは荷物に持っているだけで撃てます
...
1. HUB01のインターコムで(もう一度後輩のママについて尋ねる)を選ぶ
   - 両方のミッションを成功裏に終わらせた場合、この後で後輩と会話するとクエストクリア
   - 「鉄塊狩り」のターゲットを壊してミッション失敗した場合、クエスト継続

1. (クエスト継続の場合)HUB01のミッション「輝かしい捜索任務」をクリアする
   - 街中にあるビルの地下からアイテムを回収するクエストです
   - 街中、特殊敵、閉所の多い地下、毒ガス地形ありという難クエストなのでしっかり準備していきましょう
   ...
   - その代わり、時間制限はありません
     ...
     1. ビルの1Fを片付け<br/>
        ...
        - ガスマスクは使う【a】で有効にしないとならないタイプもあります。<br/>
        - 予備のフィルタもあった方がいいかもしれません<br/>
...
1. ミッションを報告し、インターコムで(アリーヤ博士の行方を聞く)を選択するとクリア<br/>
※つまりクリア条件は下記のいずれかです
   - 「無言の帰還」「鉄塊狩り」の両方を成功すること
   - 「輝かしい捜索任務」をクリアすること
...
### ミッション4「アリーヤ博士の行方を追う」
1. ミッション3クリア後自動開始
1. マップに表示された場所へ行き、現地で後輩と会話するとクリア<br/>
※ 依頼主は「何か見つけたら～」と言いますが、何もありません
...
- 後輩と会話せずにHUBのミッションを片付けると、ミッション3-4はスキップされます
- ミッション4の完了条件を満たした状態でミッションを開始すると、ミッション5が始まります
　
## 実績獲得条件
1. 後輩と出会った<br/>
 後輩と会話し(出会うまでの話を聞く)、を最後まで聞く
1. アリーヤ博士の残したもの<br/>
 ミッション5「アリーヤ博士の行方を追う」を完了する
...
　基本的には仲間として役に立つように初期能力をやや強力にしてはいるものの、特質や外見はランダムなのどうしても気に入らなければ世界を初期化してプレイヤーの新規作成をしてください。
...
### 装備と持ち物
職業「高校生」の服装「女性」で開始したときと同じですが、下半身装備はジーンズでなくスカートにしています
...
1. ミッション2開始(HUB01を目指そう)
1. ミッション2終了(HUB01を目指そう)
