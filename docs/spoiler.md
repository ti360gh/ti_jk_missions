...
- ミッションはフレーバー優先です。クリアしたら強力なアイテムがもらえるなんてことはありません。<br/>急いでも有利にはならないので後回しでも大丈夫です。一般報酬も設定してません。
...
目的地でない同じタイプの科学研究所でもクリア条件を満たします。<br/>
ミッションのためなら地下に入る必要はありません。<br/>
ミッションの建物はランダムな区画を持つ地下3マス確定の専用ラボムです。<br/>
3マスなので最奥の部屋がふたつあり運がよければ図書室や武器庫がありますが、運が悪ければ巨大骸骨とかショゴスがいる場合もありますので潜るときは気をつけて。
...
- ミッション1クリア時点でHUB01のインターコムに話しかけていない場合
  ...
  1. マップに表示されたハブ01にたどり着き、インターコムで追加選択肢(後輩のママについて尋ねる)を選ぶ
  1. 後輩と会話するとクリア

- ミッション1クリア前にHUB01のインターコムに話しかけた場合
  1. インターコムと会話後に、後輩との会話に(\[ミッション\]相談を聞く)が現れるので選ぶ
  1. もう一度インターコムに話しかけ、追加選択肢(後輩のママについて尋ねる)を選ぶ
  1. 後輩と会話するとクリア

- **【注意】**ミッション1受領前にHUB01のインターコムに話しかけた場合<br/>
※ミッション1の開始メッセージがミッション2に上書きされるので、ミッション1が開始できなくなります<br/>
　進行は上記「ミッション1クリア前にHUB01のインターコムに話しかけた場合」と同じです

- ミッション報酬<br/>
特になし。HUB01の場所が明らかになります。

### ミッション3「ハブの信用を得るには」
1. ミッション2クリア後、後輩と会話し(\[ミッション\]相談を聞く)を選ぶ
...
1. 上記ミッションクリア後に、HUB01のインターコムで追加選択肢(後輩のママの名前を伝える)を選ぶ
1. 後輩と会話するとクリア
...
### ミッション4「ハブの信用を得るには2」
1. ミッション2クリア後、後輩と会話し(\[ミッション\]相談を聞く)を選ぶ
1. 後輩と会話し、HUB01のミッション「無言の帰還」と「鉄塊狩り」をクリアする
...
1. ミッションを報告し、後輩と会話するとようやくクリア<br/>
...
- 後輩と会話せずにHUBのミッションを全部片付けても進行やダイアログに変化はありません。(念のため)
　
## 実績獲得条件
1. 後輩と出会った<br/>
...
　ランダムで付与されるその他の特質は、必ずしもNPCにとって意味のある物とは限りません(暑がり/寒がりなど。賑やかしです)。
...
### ステータスのクラスボーナス
 すべて+0から+4(8-12)<br/>
 基本ステータスに1/2で+1することを4回繰り返すので、ステータスは9-10程度に収まる可能性が高いです<br/>
