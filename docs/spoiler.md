...
- クリア条件<br/>
  1. 後輩と会話してHUB01への協力を決める
  1. 上記1を実施せずにミッション3のクリア条件を満たす
...
- 開始条件</br>
  1. ミッション2終了後に自動開始<br/>
※ミッション2のクリア条件2を満たした場合はこのミッションはスキップされます

- クリア条件(いずれか)
  1. 「無言の帰還」と「鉄塊狩り」を成功し、インターコムに(娘が……)を選ぶ
  2. 「輝かしい捜索任務」をクリアし、インターコムに(娘が……)を選ぶ
...
- 開始条件(いずれか)
  1. ミッション3終了後に自動開始<br/>
  1. ミッション3をスキップできるなら自動開始

- クリア条件(いずれか)
  1. 「無言の帰還」と「鉄塊狩り」を成功し、インターコムに(改めてアリーヤ博士の……)を選ぶ
  2. 「輝かしい捜索任務」をクリアし、インターコムに(改めてアリーヤ博士の……)を選ぶ
...
- 後輩と会話せずにHUBのミッションを片付けるとミッション3はスキップできます。
- つまり必須ミッションはミッション2 -> ミッション4というわけですが、スキップする意味はあんまりないはずです<br/>
一応チェックはしていますが、メッセージのつじつまが合わなくなることはあるかもしれません。<br/>
もしフラグ壊れたら教えてください。
　
## 実績獲得条件
1. 後輩と出会った<br/>
